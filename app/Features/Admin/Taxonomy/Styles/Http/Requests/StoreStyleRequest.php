...
final class StoreStyleRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'max:120', Rule::unique('artwork_styles', 'name')],
    ...
    public function after(): array
    {
        return [function (Validator $validator): void {
            ...
            if ($name !== '' && TaxonomyData::slugExists(ArtworkStyle::class, $name)) {

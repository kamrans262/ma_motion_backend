...
<section class="ma-page-heading">
    <div>
        ...
        <h2>Makers</h2>
        <p>Review Maker accounts and manage the profile information that powers discovery across MA Motion.</p>
    </div>
    ...
    @else
        <div class="ma-table-wrap">
            <table class="ma-table">
                <thead><tr><th scope="col">Maker</th><th scope="col">Location</th><th scope="col">Status</th><th scope="col">Profile</th><th scope="col">Action</th></tr></thead>
                <tbody>
